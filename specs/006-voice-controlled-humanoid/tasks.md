...
- [ ] T015 [M1] Conduct research for Module 1 ROS 2 content in specs/002-module-01-ros2/research.md
- [ ] T016 [M1] Gather 10–20 authoritative sources (min 40% academic: research papers, ROS 2 docs, robotics textbooks)
- [ ] T017 [M1] Validate all source URLs/DOIs and document in APA/IEEE format

### Implementation for Module 1

- [ ] T018 [P] [M1] Create docs/module-01-ros2/01-introduction.md with learning objectives, motivation, ROS 2 overview
- [ ] T019 [P] [M1] Write docs/module-01-ros2/02-ros2-basics.md covering nodes, topics, services, parameters
- [ ] T020 [P] [M1] Write docs/module-01-ros2/03-python-integration.md with rclpy examples and publisher/subscriber code
- [ ] T021 [P] [M1] Create docs/module-01-ros2/04-urdf-fundamentals.md explaining URDF structure, links, joints
- [ ] T022 [P] [M1] Write docs/module-01-ros2/05-humanoid-urdf.md with humanoid robot URDF example and visualization
- [ ] T023 [M1] Create docs/module-01-ros2/06-mini-project-ros2-communication.md with hands-on node communication project
- [ ] T024 [P] [M1] Test all Python code examples in ROS 2 environment (Humble or Iron)
- [ ] T025 [P] [M1] Create ROS 2 node diagrams in static/diagrams/module-01/
- [ ] T026 [M1] Add 3–5 exercises per chapter for student practice
- [ ] T027 [M1] Validate Flesch-Kincaid readability (grade 8–10) for all Module 1 chapters
- [ ] T028 [M1] Run constitution compliance check (Academic Rigor, Clarity, Modularity, Code Quality, Structural Consistency, Build Integrity)
